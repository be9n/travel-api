...
class ToursListTest extends TestCase
{
    ...
    {
        $toursPerPage = config('app.paginationCount.tours');
    ...
    public function test_tours_list_sorted_by_starting_date_correctly(): void
    {
    ...
    public function test_tours_list_sorted_by_price_correctly(): void
    {
    ...
    public function test_tours_list_filters_by_price_correctly(): void
    {
        ...
        $endpoint = '/api/travel/' . $travel->slug . '/tours';
    ...
    public function test_tours_list_returns_validation_errors(): void
    {
        ...
        $response = $this->getJson($endpoint.'?dateFrom=weg');
        $response->assertStatus(422);

        $response = $this->getJson($endpoint.'?priceFrom=weg');
        $response->assertStatus(422);

        $response = $this->getJson($endpoint.'?sortBy=weg&sortOrder=weg');
        $response->assertStatus(422);
    }
}
